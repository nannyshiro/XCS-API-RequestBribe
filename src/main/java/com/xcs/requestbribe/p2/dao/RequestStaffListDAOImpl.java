    ...
    public RequestStaffList RequestStaffListgetByCon(RequestStaffListgetByConReq req) {
        ...
        List<RequestStaffListResultSet> dataList = getJdbcTemplate().query(sqlBuilder.toString(), new RowMapper<RequestStaffListResultSet>() {
            ...
            public RequestStaffListResultSet mapRow(ResultSet rs, int rowNum) throws SQLException {
                ...
                item.setNOTICE_MANAGEMENT_POS_LEVEL_NAME(rs.getString("NOTICE_MANA_POS_LEVEL_NAME"));
                ...
                item.setNOTICE_OPERATION_POS_LEVEL_NAME(rs.getString("NOTICE_OPER_POS_LEVEL_NAME"));
                ...
                item.setARREST_MANAGEMENT_POS_LEVEL_NAME(rs.getString("ARREST_MANA_POS_LEVEL_NAME"));
                ...
                item.setARREST_OPERATION_POS_LEVEL_NAME(rs.getString("ARREST_OPER_POS_LEVEL_NAME"));
                ...
                item.setLAWSUIT_MANAGEMENT_POS_LEVEL_NAME(rs.getString("LAWSUIT_MANA_POS_LEVEL_NAME"));
                ...
                item.setLAWSUIT_OPERATION_POS_LEVEL_NAME(rs.getString("LAWSUIT_OPER_POS_LEVEL_NAME"));
                ...
                item.setPROVE_MANAGEMENT_POS_LEVEL_NAME(rs.getString("PROVE_MANA_POS_LEVEL_NAME"));
                ...
                item.setCOMPARE_MANAGEMENT_POS_LEVEL_NAME(rs.getString("COMPARE_MANA_POS_LEVEL_NAME"));
                ...
                item.setCOMPARE_OPERATION_POS_LEVEL_NAME(rs.getString("COMPARE_OPER_POS_LEVEL_NAME"));
                ...
                item.setREVENUE_MANAGEMENT_POS_LEVEL_NAME(rs.getString("REVENUE_MANA_POS_LEVEL_NAME"));
                ...
                item.setREVENUE_OPERATION_POS_LEVEL_NAME(rs.getString("REVENUE_OPER_POS_LEVEL_NAME"));
