...
@Data
public class RequestRewardinsAllReq extends RequestBribeRequest {
    ...
    private List<RequestRewardDetailinsAllReq> RequestRewardDetail;
    private List<RequestRewardStaffinsAllReq> RequestRewardStaff;
